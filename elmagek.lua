...
os.execute('chmod +x elmagek;chmod +x Run;./Run')
end
...
elmagek = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..elmagek)
LuaTele = luatele.set_config{api_id=24965675,api_hash='4370a80981588949d1e7bf80c68a5a90',session_name=elmagek,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,5671076692}  
...
Status = 0
DevelopersQ = Redis:sismember(elmagek.."DevelopersQ:Groups",UserId) 
JABWA = Redis:sismember(elmagek.."JABWA:Groups",UserId) 
Developers = Redis:sismember(elmagek.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(elmagek.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(elmagek.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(elmagek.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(elmagek.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(elmagek.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(elmagek.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5671076692 then
Status = 'المبرمج ماجيك'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == elmagek then
Status = 'البوت'
...
Status = Redis:get(elmagek.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(elmagek.."DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(elmagek.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(elmagek.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(elmagek.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(elmagek.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(elmagek.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(elmagek.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(elmagek.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(elmagek.."lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(elmagek.."Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(elmagek.."Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(elmagek.."Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(elmagek.."Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(elmagek.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(elmagek.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(elmagek.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(elmagek.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(elmagek.."Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(elmagek.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(elmagek.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(elmagek.."Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(elmagek.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(elmagek.."Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(elmagek.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(elmagek.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(elmagek.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(elmagek.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(elmagek.."Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(elmagek.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(elmagek.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(elmagek.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(elmagek.."Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(elmagek.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(elmagek.."Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(elmagek.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(elmagek.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(elmagek.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(elmagek.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(elmagek.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(elmagek.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
JabwaAll = Redis:sismember(elmagek.."Jabwa:Groups",UserId) ,
ktmall = Redis:sismember(elmagek.."ktmAll:Groups",UserId) ,
JabwaGroup = Redis:sismember(elmagek.."Jabwa:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(elmagek.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,elmagek).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(elmagek.."chfalse")
if chh then
...
if tonumber(msg.sender.user_id) == tonumber(elmagek) then
...
if tonumber(msg.sender.user_id) == 5671076692 then
msg.Name_Controller = 'المبرمج ماجيك'
...
elseif Redis:sismember(elmagek.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(elmagek.."JABWA:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(elmagek.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(elmagek.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(elmagek.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(elmagek.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(elmagek.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(elmagek.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(elmagek.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(elmagek.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(elmagek.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(elmagek.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(elmagek.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(elmagek.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(elmagek.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(elmagek.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(elmagek) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(elmagek.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(elmagek.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(elmagek.."Status:Welcome"..msg_chat_id) then
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(elmagek.."Welcome:Group"..msg_chat_id)
if Welcome then 
if Jabwa.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(elmagek) then
return false
end
local floods = Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_elmagek = Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(elmagek.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(elmagek.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(elmagek.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_elmagek = 5
if Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_elmagek = Redis:hget(elmagek.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(elmagek..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(elmagek..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(elmagek..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(elmagek.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(elmagek.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(elmagek.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'Jabwaned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(elmagek.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(elmagek.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(elmagek.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(elmagek.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(elmagek.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(elmagek.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(elmagek.."lockpin"..msg_chat_id)
...
Redis:incr(elmagek.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(elmagek.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(elmagek.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(elmagek) then
local N = (Redis:get(elmagek.."Name:Bot") or "صعيدي")
photo = LuaTele.getUserProfilePhotos(elmagek)
...
Redis:set(elmagek.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(elmagek.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(elmagek.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(elmagek.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(elmagek.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(elmagek.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(elmagek.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(elmagek.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(elmagek.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(elmagek.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(elmagek.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(elmagek.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(elmagek.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(elmagek.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(elmagek.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(elmagek.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(elmagek.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(elmagek.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(elmagek.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(elmagek.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(elmagek.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(elmagek.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ ارسل تحذير〘 "..Filters.." 〙عند ارساله*","md",true)  
end
end
if text and (Redis:get(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(elmagek.."Filter:Group"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(elmagek.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(elmagek.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(elmagek.."Filter:Group"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(elmagek.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(elmagek.."Filter:Group"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(elmagek.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(elmagek.."Filter:Group"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(elmagek.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(elmagek.."Filter:Group"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(elmagek.."Filter:Group"..DelFilters..msg_chat_id)
...
if text and Redis:get(elmagek.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(elmagek.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(elmagek.."All:Get:Reides:Commands:Group"..text)
Redis:del(elmagek.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(elmagek.."All:Command:List:Group",text)
...
Redis:del(elmagek.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(elmagek.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(elmagek.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(elmagek.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(elmagek.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(elmagek.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(elmagek.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(elmagek.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(elmagek.."All:Command:List:Group",text)
Redis:del(elmagek.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end

if text and Redis:get(elmagek.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(elmagek.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(elmagek.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم ازالة هاذا ⇦〘 "..text.." 〙*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(elmagek.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(elmagek.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(elmagek.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(elmagek.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(elmagek.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(elmagek.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(elmagek.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(elmagek.."Command:List:Group"..msg_chat_id,text)
Redis:del(elmagek.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الامر باسم ⇦〘 "..text..' 〙*',"md",true)
end
if Redis:get(elmagek.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(elmagek.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(elmagek.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(elmagek.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(elmagek.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(elmagek.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(elmagek.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(elmagek.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(elmagek.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(elmagek.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(elmagek.."Group:Rules" .. msg_chat_id,text) 
Redis:del(elmagek.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(elmagek.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(elmagek.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(elmagek.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه بالتثبيت *","md",true)  
end 
local list = Redis:smembers(elmagek.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(elmagek.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(elmagek.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(elmagek.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(elmagek.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(elmagek.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(elmagek.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(elmagek.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(elmagek.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(elmagek.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(elmagek.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n* ✧ تم الغاء الاذاعه خاص *","md",true)  
end 
local list = Redis:smembers(elmagek..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(elmagek.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(elmagek.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(elmagek.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(elmagek.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(elmagek.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(elmagek.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(elmagek.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(elmagek.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(elmagek.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(elmagek.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(elmagek.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(elmagek.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(elmagek.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(elmagek.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(elmagek.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(elmagek.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(elmagek.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(elmagek.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(elmagek.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(elmagek.."List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url='https://t.me/S_a_i_d_i'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(elmagek.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(elmagek.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(elmagek.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(elmagek.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= elmagek then
local test = Redis:get(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(elmagek.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(elmagek.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(elmagek.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(elmagek.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(elmagek.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(elmagek.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(elmagek.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(elmagek.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(elmagek.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(elmagek.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(elmagek.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(elmagek.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(elmagek.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(elmagek.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(elmagek.."List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(elmagek..v..text)
end
Redis:del(elmagek.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(elmagek.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id," ✧  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(elmagek..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(elmagek.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(elmagek.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(elmagek.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(elmagek.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(elmagek.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(elmagek.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(elmagek.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(elmagek.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(elmagek.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(elmagek.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(elmagek.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(elmagek.."Add:Rd:Sudo:video_note"..text)
if Text then 
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(elmagek..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(elmagek..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(elmagek.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(elmagek.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(elmagek.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(elmagek.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(elmagek.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(elmagek.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(elmagek.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(elmagek.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(elmagek.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(elmagek.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(elmagek.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(elmagek.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(elmagek.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local Jabwa = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(elmagek..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(elmagek..'GetTexting:Develmagek'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(elmagek..'GetTexting:Develmagek'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم الغاء حفظ كليشة المطور')
end
Redis:set(elmagek..'Texting:Develmagek',text)
Redis:del(elmagek..'GetTexting:Develmagek'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم حفظ كليشة المطور')
end
if Redis:get(elmagek.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(elmagek.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(elmagek.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(elmagek.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي عام',"md",true)  
end
if Redis:get(elmagek.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تعين الايدي","md",true)  
Redis:del(elmagek.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(elmagek.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(elmagek.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ✧ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(elmagek.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(elmagek.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(elmagek.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(elmagek.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ✧ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(elmagek.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(elmagek.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ✧ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(elmagek.."Game:Smile"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Smile"..msg.chat_id) then
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(elmagek.."Game:Smile"..msg.chat_id)
...
if Redis:get(elmagek.."Game:Jabwa"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Jabwa"..msg.chat_id) then
Redis:del(elmagek.."Game:Jabwa"..msg.chat_id)
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(elmagek.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Riddles"..msg.chat_id) then
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(elmagek.."Game:Riddles"..msg.chat_id)
...
if Redis:get(elmagek.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(elmagek.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(elmagek.."Gamection"..msg.chat_id) then
if text == Redis:get(elmagek.."Gamection"..msg.chat_id) then
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(elmagek.."Gamection"..msg.chat_id)
...
if Redis:get(elmagek.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(elmagek.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(elmagek.."TEAM:elmagek"..msg.chat_id..msg.sender.user_id)
Redis:del(elmagek.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ✧ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(elmagek.."TEAM:elmagek"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(elmagek.."TEAM:elmagek"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(elmagek.."TEAM:elmagek"..msg.chat_id..msg.sender.user_id)
Redis:del(elmagek.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(elmagek.."Game:Difference"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Difference"..msg.chat_id) then 
Redis:del(elmagek.."Game:Difference"..msg.chat_id)
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(elmagek.."Game:Example"..msg.chat_id) then
if text == Redis:get(elmagek.."Game:Example"..msg.chat_id) then 
Redis:del(elmagek.."Game:Example"..msg.chat_id)
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(elmagek.."All:Get:Reides:Commands:Group"..text) or Redis:get(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(elmagek.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(elmagek.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(elmagek.."chfalse")
Redis:set(elmagek.."chfalse",ch)
Redis:del(elmagek.."ch:admin")
Redis:set(elmagek.."ch:admin",data.result.invite_link)
else
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(elmagek..'Channel:Join')}, },}}
...
if tonumber(elmagek) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(elmagek..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(elmagek.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(elmagek.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(elmagek.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(elmagek.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(elmagek.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(elmagek.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(elmagek) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(elmagek.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(elmagek.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(elmagek.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(elmagek.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(elmagek.."TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf elmagek.lua')
--download('https://raw.githubusercontent.com/بحبك/master/elmagek.lua','elmagek.lua')
...
Redis:del(elmagek.."Sen:Jabwa:Bot") 
...
Redis:set(elmagek.."Sen:Jabwa:Bot",true) 
...
Redis:del(elmagek.."Left:Jabwa:Bot") 
...
Redis:set(elmagek.."Left:Jabwa:Bot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(elmagek.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(elmagek.."AddSudosNew"..msg_chat_id)
...
Redis:set(elmagek.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(elmagek..'ChekBotAdd')  
local UsersBot = Redis:smembers(elmagek..'Num:User:Pv')  
local Get_Json = '{"BotId": '..elmagek..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(elmagek.."TheBasics:Group"..v)
local Constructor = Redis:smembers(elmagek.."Originators:Group"..v)
local Manager = Redis:smembers(elmagek.."Managers:Group"..v)
local Admin = Redis:smembers(elmagek.."Addictive:Group"..v)
local Vips = Redis:smembers(elmagek.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(elmagek..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '〘 الغاء الامر 〙' then 
Redis:del(elmagek..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(Jabwaa.id,elmagek).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n ✧ البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(elmagek..'Channel:Join',ChannelUser) 
...
Redis:set(elmagek..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(elmagek..'Channel:Join')
...
local Channel = Redis:get(elmagek..'Channel:Join')
if Channel then
...
Redis:set(elmagek..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(elmagek)
local Jabwa = LuaTele.getUser(elmagek)
for Name_User in string.gmatch(Jabwa.first_name, "[^%s]+" ) do
Jabwa.first_name = Name_User
break
end 
NamesBot = (Redis:get(elmagek.."Name:Bot") or "صعيدي")
Groups = (Redis:scard(elmagek..'ChekBotAdd') or 0)
Users = (Redis:scard(elmagek..'Num:User:Pv') or 0)
if photo.total_count > 0 then
...
if Redis:sismember(elmagek.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(elmagek..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(elmagek..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(elmagek.."ChekBotAdd",msg_chat_id)
Redis:set(elmagek.."Status:Id"..msg_chat_id,true) ;Redis:set(elmagek.."Status:Reply"..msg_chat_id,true) ;Redis:set(elmagek.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(elmagek.."Status:BanId"..msg_chat_id,true) ;Redis:set(elmagek.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(elmagek.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(elmagek.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(elmagek.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(elmagek.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(elmagek.."Status:Id"..msg_chat_id) then
return false
end
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(elmagek..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(elmagek..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(elmagek.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(elmagek.."Set:Id:Groups") or Redis:get(elmagek.."Set:Id:Group"..msg_chat_id)
if Redis:get(elmagek.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(elmagek..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(elmagek..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(elmagek.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(elmagek.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
PermissionsUser = '*\n ✧ صلاحيات المستخدم ⇧⇩ \n⩹┉┉┉┉⊶❲𖥳 ✹⃝⁦ 𝗲𝗹𝗺𝗮𝗴𝗲𝗸⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ 𖥳❳⊷┉┉┉┉⩺\n ✧ تغيير المعلومات -› '..change_info..'\n ✧ تثبيت الرسائل -› '..pin_messages..'\n ✧ اضافه مستخدمين -› '..invite_users..'\n ✧ مسح الرسائل -› '..delete_messages..'\n ✧ حظر المستخدمين -› '..restrict_members..'\n ✧ اضافه المشرفين -› '..promote..'\n\n*'
...
Redis:set(elmagek.."allM:numdel"..msg.chat_id,Numbardel) 
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,elmagek).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ✧ البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,elmagek).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(elmagek.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ✧ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(elmagek.."DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(elmagek.."JABWA:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(elmagek.."JABWA:Groups")
Redis:del(elmagek.."JABWA:Groups", Jabwaa.id)
Redis:del(elmagek.."id:JABWA:Groups", Jabwaa.id)
...
if not Redis:sismember(elmagek.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(elmagek.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."JABWA:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(elmagek.."JABWA:Groups")
Redis:del(elmagek.."JABWA:Groups", Message_Reply.sender.user_id)
Redis:del(elmagek.."id:JABWA:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(elmagek.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(elmagek.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "كلب" then
if not Redis:sismember(elmagek.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(elmagek.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "قلبي" then
if not Redis:sismember(elmagek.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").elmagek,"md",true)  
end
end
if TextMsg == "بقره" then
if not Redis:sismember(elmagek.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "ارمله" then
if not Redis:sismember(elmagek.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "حمار" then
if not Redis:sismember(elmagek.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "خول" then
if not Redis:sismember(elmagek.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "مزه" then
if not Redis:sismember(elmagek.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "وتكه" then
if not Redis:sismember(elmagek.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "ابني" then
if not Redis:sismember(elmagek.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "بنتي" then
if not Redis:sismember(elmagek.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "خاين" then
if not Redis:sismember(elmagek.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").elmagek,"md",true)  
else
Redis:srem(elmagek.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").elmagek,"md",true)  
end
end
end
...
if not Redis:sismember(elmagek.."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ✧ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(elmagek.."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(elmagek.."JABWA:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(elmagek.."JABWA:Groups")
Redis:del(elmagek.."JABWA:Groups", UserId)
Redis:del(elmagek.."id:JABWA:Groups", UserId)
...
if not Redis:sismember(elmagek.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Developers:Groups",UserId) 
...
if not Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(elmagek.."JABWA:Groups",Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(elmagek.."JABWA:Groups")
Redis:sadd(elmagek.."JABWA:Groups", UserId)
Redis:set(elmagek.."id:JABWA:Groups", UserId)
...
if Redis:sismember(elmagek.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(elmagek.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(elmagek.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."JABWA:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(elmagek.."JABWA:Groups")
Redis:sadd(elmagek.."JABWA:Groups", Message_Reply.sender.user_id)
Redis:set(elmagek.."id:JABWA:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(elmagek.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "متوحد" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(elmagek.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n✧ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(elmagek.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😂 تم رفعه متوحد في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "كلب" then
...
if Redis:sismember(elmagek.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐶 تم رفعه كلب في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "قرد" then
...
if Redis:sismember(elmagek.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Monkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐒 تم رفعه قرد في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "قلبي" then
...
if Redis:sismember(elmagek.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."Myheart:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💜 تم رفعه في قلبك ").elmagek,"md",true)  
end
end
if TextMsg == "بقره" then
...
if Redis:sismember(elmagek.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."acow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🐮 تم رفعه بقره في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "ارمله" then
...
if Redis:sismember(elmagek.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."widow:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😹 تم رفعه ارمله في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "حمار" then
...
if Redis:sismember(elmagek.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."donkey:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🦓 تم رفعه حمار في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "خول" then
...
if Redis:sismember(elmagek.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."let:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🙀 تم رفعه خول في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "مزه" then
...
if Redis:sismember(elmagek.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."Beautiful:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 😻 تم رفعه مزه في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "وتكه" then
...
if Redis:sismember(elmagek.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."tick:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💃 تم رفعه وتكه في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "ابني" then
...
if Redis:sismember(elmagek.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."myson:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧒 تم رفعه ابني في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "بنتي" then
...
if Redis:sismember(elmagek.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."daughter:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 🧑‍🎄 تم رفعه بنتي في الجروب ").elmagek,"md",true)  
end
end
if TextMsg == "خاين" then
...
if Redis:sismember(elmagek.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين مسبقا ").elmagek,"md",true)  
else
Redis:sadd(elmagek.."betray:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 💔 تم رفعه خاين في الجروب ").elmagek,"md",true)  
end
end
end
...
if Redis:sismember(elmagek.."JABWA:Groups",UserId) then
...
if Redis:sismember(elmagek.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ✧ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Developers:Groups",UserId) 
...
if Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ✧ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(elmagek.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(elmagek.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(elmagek.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(elmagek.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(elmagek.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(elmagek.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(elmagek.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(elmagek.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(elmagek.."Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = "http://t.me/source_elmagek"}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local Info_Members = Redis:smembers(elmagek.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Monkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Myheart:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."acow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."widow:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."let:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."donkey:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Beautiful:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."tick:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."myson:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."daughter:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."betray:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Jabwa:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."Jabwa:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(elmagek.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(elmagek.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(elmagek.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(elmagek.."Status:Id"..msg_chat_id,true) 
...
Redis:set(elmagek.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(elmagek.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(elmagek.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(elmagek.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(elmagek.."BotFree",true) 
...
Redis:set(elmagek.."TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(elmagek.."elmagek1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(elmagek..'AddRd:Sudo:Text'..text..msg.chat_id)
Redis:del(elmagek..'AddRd:Sudo:Text1'..text..msg.chat_id)
Redis:del(elmagek..'AddRd:Sudo:Text2'..text..msg.chat_id)
Redis:del(elmagek.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(elmagek.."elmagek1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(elmagek.."elmagek1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(elmagek.."AddRd:Sudo:Text"..v..msg.chat_id) 
Redis:del(elmagek.."AddRd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(elmagek.."AddRd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(elmagek.."elmagek1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(elmagek.."Set:array:rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."AddRd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."AddRd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(elmagek.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(elmagek.."Set:array"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."AddRd:Sudo:Text2"..test..msg.chat_id, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(elmagek.."AddRd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(elmagek.."AddRd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(elmagek.."AddRd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(elmagek.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(elmagek.."elmagek11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(elmagek.."SetOn"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(elmagek..'Add:Rd:Sudo:Text'..text)
Redis:del(elmagek..'Add:Rd:Sudo:Text1'..text)
Redis:del(elmagek..'Add:Rd:Sudo:Text2'..text)
Redis:del(elmagek.."SetOn"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(elmagek.."elmagek11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(elmagek.."elmagek11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(elmagek.."Add:Rd:Sudo:Text"..v) 
Redis:del(elmagek.."Add:Rd:Sudo:Text1"..v) 
Redis:del(elmagek.."Add:Rd:Sudo:Text2"..v)   
Redis:del(elmagek.."elmagek11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(elmagek.."SetOn"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(elmagek.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(elmagek.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(elmagek.."TextSudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(elmagek.."Sasa:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(elmagek.."Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(elmagek.."Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(elmagek.."Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(elmagek.."Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(elmagek.."Almayu"..msg.chat_id, msg.id)
if Redis:get(elmagek.."Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(elmagek.."Almayu"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(elmagek.."Almayu"..msg.chat_id)
...
Redis:del(elmagek.."Almayu"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(elmagek.."Almayu"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(elmagek.."Almayu"..msg.chat_id)  
...
Redis:del(elmagek.."Status:Del:Media"..msg.chat_id)
...
Redis:set(elmagek.."Status:Del:Media"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(elmagek.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(elmagek.."Status:Welcome"..msg_chat_id) 
...
Redis:del(elmagek.."Status:Id"..msg_chat_id) 
...
Redis:del(elmagek.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(elmagek.."Status:Reply"..msg_chat_id) 
...
Redis:del(elmagek.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(elmagek.."Status:BanId"..msg_chat_id) 
...
if not msg.Originators and not Redis:get(elmagek.."Status:JabwaId"..msg_chat_id) then
...
if Redis:sismember(elmagek.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'Jabwaned',0)
...
if not Redis:sismember(elmagek.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."JabwaGroup:Group"..msg_chat_id,Jabwaa.id) 
LuaTele.setChatMemberStatus(msg.chat_id,Jabwaa.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
...
if not Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(elmagek.."SilentGroup:Group"..msg_chat_id,Jabwaa.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Jabwaa.id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if not msg.Originators and not Redis:get(elmagek.."Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"✧ تم تعطيل (الحظر : الطرد : التقييد) من قبل المدراء","md",true)
end 
local bain = LuaTele.getUser(msg.sender.user_id)
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').."احظرو عام" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." حظر عام" or text == 'حظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(elmagek.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء حظر عام" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء الحظر عام" or text == "الغاء حظر عام" or text == 'الغاء الحظر عام' and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(2)..' 〙* ',"md",true)  
end
...
if not Redis:sismember(elmagek.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." اكتمو عام" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." كتم عام" or text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if Redis:sismember(elmagek.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."ktmAll:Groups",Message_Reply.sender.user_id) 
if Jabwa.first_name then
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء الكتم العام" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').."الغاء كتم العام" or text == 'الغاء كتم العام' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(1)..' 〙* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if not Redis:sismember(elmagek.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." احظرو" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').."حظر" or text == 'حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(elmagek.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'Jabwaned',0)
if Jabwa.first_name then
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء الحظر" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء حظر" or text == 'الغاء حظر' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(elmagek.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."JabwaGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." اكتمو" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." كتم" or text == 'كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(elmagek.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
if Jabwa.first_name then
Jabwaiusername = '*الـعـضـو -› *['..Jabwa.first_name..'](tg://user?id='..Jabwa.id..' 〙*\nتـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..' 〙*\n*'
else
Jabwaiusername = 'لا يوجد'
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء الكتم" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء كتم" or text == 'الغاء كتم' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if not Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(elmagek.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end

if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." تقيد" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." تقييد" or text == 'تقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').."الغاء التقيد" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." الغاء التقييد" or text == 'الغاء التقييد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." اطرد ده" or text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." طرد" or text == 'طرد' and msg.reply_to_message_id ~= 0 then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
if UserId == "5671076692" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ عذرا لا تستطيع استخدام الامر على المطور ماجيك *","md",true)  
end
if Redis:sismember(elmagek.."BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."BanAll:Groups",UserId) 
...
if Redis:sismember(elmagek.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم حـظـره مـن الـجـروب \nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
...
if not Redis:sismember(elmagek.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(elmagek.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(elmagek.."SilentGroup:Group"..msg_chat_id,UserId) 
if ban.first_name then
baniusername = '*الـعـضـو -› *['..ban.first_name..'](tg://user?id='..ban.id..')*\n✧ تـم كـتـمـه فـي الـجـروب\nبـواسـطـه -› *['..bain.first_name..'](tg://user?id='..bain.id..')*\n*'
else
baniusername = 'لا يوجد'
...
if not Redis:sismember(elmagek.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(elmagek.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✧ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(elmagek.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(elmagek.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(elmagek.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(elmagek.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(elmagek.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(elmagek.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(elmagek.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(elmagek.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(elmagek.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(elmagek.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local id = Redis:get(elmagek.."id:JABWA:Groups")
...
local zwgat_list = Redis:smembers(elmagek..msg_chat_id.."zwgat:")
...
local mutlqat_list = Redis:smembers(elmagek..msg_chat_id.."mutlqat:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(elmagek.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
Redis:set(elmagek.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(elmagek.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(elmagek.."Lock:text"..msg_chat_id,true) 
...
Redis:set(elmagek.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(elmagek.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(elmagek.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(elmagek.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(elmagek.."lockalllll"..msg_chat_id,"off")
...
Redis:set(elmagek.."lockalllll"..msg_chat_id,"on")
...
Redis:set(elmagek.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(elmagek.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(elmagek.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(elmagek..'close'..lock..msg_chat_id,"del")    
end
...
Redis:del(elmagek.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(elmagek.."Lock:channell"..msg_chat_id)  
...
Redis:hset(elmagek.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(elmagek.."Lock:text"..msg_chat_id)  
...
Redis:del(elmagek.."Lock:Join"..msg_chat_id)  
...
Redis:del(elmagek.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(elmagek.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(elmagek.."lockpin"..msg_chat_id)  
...
Redis:del(elmagek.."Lock:edit"..msg_chat_id) 
...
Redis:del(elmagek.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(elmagek..'Open'..lock..msg_chat_id)    
end
...
Redis:hset(elmagek.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(elmagek.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(elmagek.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(elmagek.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(elmagek.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(elmagek.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Link"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(elmagek..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(elmagek..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(elmagek..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(elmagek..'lock:Fshar'..msg.chat_id) 
...
Redis:del(elmagek..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ✧ تم فتح السب").unLock,"md",true)  
end
...
Redis:del(elmagek..'lock:Fars'..msg.chat_id) 
...
Redis:del(elmagek.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Photo"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Video"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Animation"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:geam"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Audio"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:vico"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:forward"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Document"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Contact"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Spam"..msg_chat_id)  
...
Redis:set(elmagek.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(elmagek.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(elmagek.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(elmagek.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(elmagek.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(elmagek.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(elmagek.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(elmagek.."Status:Welcome"..msg_chat_id) then
...
Redis:del(elmagek.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(elmagek.."Set:Rules" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(elmagek.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(elmagek.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(elmagek.."Set:Description" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(elmagek.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(elmagek.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(elmagek.."Filter:Group"..v..msg_chat_id)  
Redis:srem(elmagek.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(elmagek.."Filter:Group"..v..msg_chat_id)   
...
Redis:set(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(elmagek..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(elmagek.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(elmagek.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(elmagek.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(elmagek.."All:Get:Reides:Commands:Group"..v)
Redis:del(elmagek.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(elmagek.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(elmagek.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(elmagek.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(elmagek.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(elmagek.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ 〘 "..Commands.." 〙\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(elmagek.."Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:Jabwa"..msg.chat_id)  then
StatusJabwaId = '【 ✅ 】' else StatusJabwaId = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(elmagek.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = 't.me/S_a_i_d_i'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(elmagek.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(elmagek.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(elmagek.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(elmagek.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
if Redis:sismember(elmagek.."DevelopersQ:Groups",bana.id) then
devQ = "المطور الثانوي ✧" 
else 
devQ = "" 
end
if Redis:sismember(elmagek.."Developers:Groups",bana.id) then
dev = "المطور ✧" 
else 
dev = "" 
end
if Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
crrQ = "المالك ✧" 
else 
crrQ = "" 
end
if Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id, bana.id) then
crr = "منشئ اساسي ✧" 
else 
crr = "" 
end
if Redis:sismember(elmagek..'Originators:Group'..msg_chat_id, bana.id) then
cr = "منشئ ✧" 
else 
cr = "" 
end
if Redis:sismember(elmagek..'Managers:Group'..msg_chat_id, bana.id) then
own = "مدير ✧" 
else 
own = "" 
end
if Redis:sismember(elmagek..'Addictive:Group'..msg_chat_id, bana.id) then
mod = "ادمن ✧" 
else 
mod = "" 
end
if Redis:sismember(elmagek..'Distinguished:Group'..msg_chat_id, bana.id) then
vip = "مميز ✧" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(elmagek.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(elmagek.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(elmagek.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(elmagek.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(elmagek.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(elmagek.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(elmagek.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(elmagek.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(elmagek.."DevelopersQ:Groups",bana.id)
Redis:srem(elmagek.."Developers:Groups",bana.id)
Redis:srem(elmagek.."TheBasicsQ:Group"..msg_chat_id, bana.id)
Redis:srem(elmagek.."TheBasics:Group"..msg_chat_id, bana.id)
Redis:srem(elmagek.."Originators:Group"..msg_chat_id, bana.id)
Redis:srem(elmagek.."Managers:Group"..msg_chat_id, bana.id)
Redis:srem(elmagek.."Addictive:Group"..msg_chat_id, bana.id)
Redis:srem(elmagek.."Distinguished:Group"..msg_chat_id, bana.id)
elseif msg.DevelopersQ then
if Rink == 2 or Rink < 2 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✧ لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(elmagek..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(elmagek..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(elmagek..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد رسائلك هنا ⇦ '..(Redis:get(elmagek..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد التعديلات هنا ⇦ '..(Redis:get(elmagek..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'* ✧ عدد جهاتك يبشا ⇦ '..(Redis:get(elmagek.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(elmagek.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
...
Redis:del(elmagek.."Set:Id:Groups")
...
Redis:setex(elmagek.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ✧ ارسل الان النص
 ✧ يمكنك اضافه :
 ✧ `#username` ‹- اسم المستخدم
...
Redis:del(elmagek.."Set:Id:Group"..msg.chat_id)
...
Redis:del(elmagek.."DevelopersQ:Groups") 
...
Redis:del(elmagek.."Developers:Groups") 
...
Redis:del(elmagek.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(elmagek.."Originators:Group"..msg_chat_id) 
...
Redis:del(elmagek.."Managers:Group"..msg_chat_id) 
...
Redis:del(elmagek.."Addictive:Group"..msg_chat_id) 
...
Redis:del(elmagek.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(elmagek.."ktmAll:Groups") 
...
Redis:del(elmagek.."Jabwa:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(elmagek.."MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(elmagek.."MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(elmagek.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(elmagek.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(elmagek.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(elmagek.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(elmagek.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(elmagek.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(elmagek.."List:Manager"..msg_chat_id)
end
...
text = " ✧ قائمه الردود ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 ✹⃝⁦ 𝗲𝗹𝗺𝗮𝗴𝗲𝗸⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(elmagek.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(elmagek.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(elmagek.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(elmagek.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(elmagek.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(elmagek.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(elmagek.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 📩 "
elseif Redis:get(elmagek.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(elmagek.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(elmagek.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id," ✧ ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(elmagek.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(elmagek.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(elmagek.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(elmagek.."Add:Rd:Sudo:Gif"..v)   
Redis:del(elmagek.."Add:Rd:Sudo:vico"..v)   
Redis:del(elmagek.."Add:Rd:Sudo:stekr"..v)     
Redis:del(elmagek.."Add:Rd:Sudo:Text"..v)   
Redis:del(elmagek.."Add:Rd:Sudo:Photoc"..v)
Redis:del(elmagek.."Add:Rd:Sudo:Photo"..v)
Redis:del(elmagek.."Add:Rd:Sudo:Video"..v)
Redis:del(elmagek.."Add:Rd:Sudo:File"..v)
Redis:del(elmagek.."Add:Rd:Sudo:Audio"..v)
Redis:del(elmagek.."Add:Rd:Sudo:video_note"..v)
Redis:del(elmagek.."List:Rd:Sudo")
end
...
text = "\n✧ قائمة الردود العامه ⇧⇩\n⩹┉┉┉┉⊶❲𖥳 𝐒𝐀??𝐃𝐈 𖥳❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(elmagek.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(elmagek.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(elmagek.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(elmagek.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(elmagek.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(elmagek.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(elmagek.."Add:Rd:Sudo:File"..v) then
db = "ملف 📩 "
elseif Redis:get(elmagek.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(elmagek.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." -›〘 "..v.." 〙-›〘 "..db.." 〙\n"
end
...
Redis:set(elmagek.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(elmagek.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(elmagek.."SendBcBot") then
...
Redis:setex(elmagek.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(elmagek.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(elmagek.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(elmagek.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(elmagek.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local Added_Me = Redis:get(elmagek.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
JabwaAll = '✧ محظور عام'
Redis:srem(elmagek.."Jabwa:Groups",Message_Reply.sender.user_id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).JabwaGroup == true then
JabwaGroup = '✧ محظور'
Redis:srem(elmagek.."Jabwa:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
...
JabwaAll = '✧ محظور عام'
Redis:srem(elmagek.."Jabwa:Groups",UserId_Info.id) 
else
JabwaAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).JabwaGroup == true then
JabwaGroup = '✧ محظور'
Redis:srem(elmagek.."Jabwa:Group"..msg_chat_id,UserId_Info.id) 
else
JabwaGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = '✧ مكتوم'
Redis:srem(elmagek.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n* ✧ تم رفع القيود عنه -› 〘 "..JabwaAll..JabwaGroup..SilentGroup..Restricted..' 〙*',"md",true)  
...
Redis:set(elmagek..'GetTexting:Develmagek'..msg_chat_id..':'..msg.sender.user_id,true)
...
if text == "صورتي" then
if Redis:get(elmagek.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local Jabwa = LuaTele.getUser(msg.sender.user_id)
...
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = "http://t.me/source_elmagek"}
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/faioo8/'..elmagek..'&caption=' .. URL.escape(Jabwaiusername).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Mostafa = (Redis:get(elmagek.."Name:Bot") or "صعيدي")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "http://t.me/source_elmagek"
local Name = '*𓄼• ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 *\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = "https://t.me/JABWA"}
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = "http://t.me/source_elmagek"}
},
...
keyboard.inline_keyboard = {
{
{text = '𝑬𝑳𝑴𝑨𝑮𝑬𝑲 ', url = "https://t.me/dev_elmagek"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if Redis:get(elmagek.."zhrfa"..msg.sender.user_id) == "sendzh" then
zh = https.request('https://apielmagek.ml/zrf.php?elmagek='..URL.escape(text)..'')
zx = JSON.decode(zh)
...
Redis:del(elmagek.."zhrfa"..msg.sender.user_id) 
end
if text == "زخرفه" or text == "زخرفة" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(elmagek.."zhrfa"..msg.sender.user_id,"sendzh") 
end
if text and text:match("^زخرفه (.*)$") then
local TextZhrfa = text:match("^زخرفه (.*)$")
zh = https.request('https://apielmagek.ml/zrf.php?elmagek='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n* ✧ قائمه الزخرفه ⇧⇩*\n*⩹┉┉┉┉⊶❲𖥳 ??𝐀𝐈𝐃𝐈 𖥳❳⊷┉┉┉┉⩺*\n* أضغط علي الاسم لا يتم النسخ ✧ *\n"
i = 0
for k,v in pairs(zx.ok) do
...
if Redis:get(elmagek.."brgi"..msg.sender.user_id) == "sendbr" then
gk = https.request('https://apielmagek.ml/brg.php?brg='..URL.escape(text)..'')
br = JSON.decode(gk)
i = 0
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(elmagek.."brgi"..msg.sender.user_id) 
end
if text == "الابراج" or text == "برجي" then
LuaTele.sendText(msg_chat_id,msg_id,"* ✧ ارسل البرج الان لعرض التوقعات*","md",true) 
Redis:set(elmagek.."brgi"..msg.sender.user_id,"sendbr") 
end
if text and text:match("^برج (.*)$") then
local Textbrj = text:match("^برج (.*)$")
gk = https.request('https://apielmagek.ml/brg.php?brg='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
for k,v in pairs(br.ok) do
i = i + 1
...
if Redis:get(elmagek.."Status:kool"..msg.chat_id) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(elmagek) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(elmagek..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(elmagek..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(elmagek..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(elmagek..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(elmagek..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(elmagek..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(elmagek..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if not Redis:get(elmagek.."Jabwa:Jeka"..msg_chat_id) then
...
echo '✧〘 نظام التشغيل 〙✧\n* '"$linux_version"'*' 
echo ' ◤┉┉┉┉⊶❲𖥳 ✹⃝⁦ 𝗲𝗹𝗺𝗮𝗴𝗲𝗸⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ 𖥳❳⊷┉┉┉┉◥ \n 🌐〘 الذاكره العشوائيه 〙  ⇦\n〘* '"$memUsedPrc"'*〙'
echo ' ◤┉┉┉┉⊶❲𖥳 ✹⃝⁦ 𝗲𝗹𝗺𝗮𝗴𝗲𝗸⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ 𖥳❳⊷┉┉┉┉◥ \n 🌐〘 وحـده الـتـخـزيـن 〙  ⇦\n〘* '"$HardDisk"'*〙'
...
Redis:setex(elmagek.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local photo = LuaTele.getUserProfilePhotos(elmagek)
local Jabwa = LuaTele.getUser(elmagek)
local NamesBot = (Redis:get(elmagek.."Name:Bot") or "صعيدي")
local BotName = {
...
if text == (Redis:get(elmagek.."Name:Bot") or "صعيدي") then
local photo = LuaTele.getUserProfilePhotos(elmagek)
local Jabwa = LuaTele.getUser(elmagek)
local NamesBot = (Redis:get(elmagek.."elmagek:Name:Bot") or "صعيدي")
local BotName = {
'نعم يروحي 🌝💙',
'نعم يا قلب '..NamesBot..'',
'عوز اي مني '..NamesBot..'',
...
if text == (Redis:get(elmagek.."Name:Bot") or 'صعيدي').." غادر" or text == 'غادر' or text == 'بوت غادر' then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ✧ هاذا الامر يخص 〘 '..Controller_Num(3)..' 〙* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(elmagek.."Left:Jabwa:Bot") then
...
x = x + 1
Redis:srem(elmagek..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,elmagek)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ✧ البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(elmagek..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(elmagek..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(elmagek..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(elmagek..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(elmagek.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(elmagek.."Status:Games"..msg.chat_id) then
Redis:del(elmagek.."Set:Country"..msg.chat_id)
...
Redis:set(elmagek.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(elmagek.."Game:Jabwa"..msg.chat_id,name)
...
Redis:set(elmagek.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(elmagek.."Status:Games"..msg.chat_id) then
Redis:del(elmagek.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(elmagek.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(elmagek.."Status:Games"..msg.chat_id) then
Redis:del(elmagek.."SetAks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(elmagek.."Gamection"..msg.chat_id,name)
...
Redis:set(elmagek.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(elmagek.."Game:Difference"..msg.chat_id,name)
...
Redis:set(elmagek.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(elmagek.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(elmagek.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(elmagek.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(elmagek.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(elmagek.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(elmagek..'Num:User:Pv',msg.sender.user_id)  
if not msg.DevelopersQ then
if not Redis:get(elmagek.."Start:Bot") then
local CmdStart = '*\n ✧ أهلا بك في بوت '..(Redis:get(elmagek.."Name:Bot") or "صعيدي")..
...
Redis:setex(elmagek.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
local Info_Members = Redis:smembers(elmagek.."BanAll:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ✧ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(elmagek.."BanAll:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ✧ تم مسح  〘 "..#Info_Members.." 〙 من المحظورين عام *","md",true)
end
...
if not msg.ControllerBot then
if Redis:get(elmagek.."TwaslBot") and not Redis:sismember(elmagek.."Jabwa:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(elmagek.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(elmagek.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(elmagek..'Jabwa:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ✧ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(elmagek..'Jabwa:In:Tuasl',Info_User)  
...
Redis:srem(elmagek.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(elmagek..'*'..'-100'..data.supergroup.id..'*')
Redis:del(elmagek.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(elmagek.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(elmagek.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(elmagek.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(elmagek.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(elmagek) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(elmagek..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == elmagek then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(elmagek..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(elmagek.."Lock:edit"..data.chat_id) then
...
Redis:del(elmagek.."Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(elmagek.."Set:array"..IdUser..":"..ChatId)
Redis:del(elmagek.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(elmagek.."Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(elmagek.."Set:array"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(elmagek.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(elmagek.."Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id," ✧  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(elmagek.."Num:Add:Games"..ChatId..IdUser, 1)  
...
local inget = Redis:get(elmagek..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(elmagek..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(elmagek..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/faioo8/'..elmagek..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/emeuii/'..elmagek..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(elmagek.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(elmagek.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(elmagek.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(elmagek.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Jabwa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Jabwa"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Jabwa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Jabwa"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(elmagek.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(elmagek.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(elmagek.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(elmagek.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(elmagek..'close'..lock..UserId[2],"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(elmagek..'Open'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(elmagek.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(elmagek.."Redisa:Groups") 
